...
export class GeminiSettings extends BaseAIServiceSettings {
    ...
    display(containerEl: HTMLElement): void {
        const geminiSettingsContainer = containerEl.createEl('div', {
            cls: 'ai-service-settings'
        });

        // 添加标题
        new Setting(geminiSettingsContainer)
            .setName('Gemini 服务')
            .setHeading();
        ...
        // 模型选择设置
        const modelSetting = new Setting(geminiSettingsContainer)
            .setName('模型')
